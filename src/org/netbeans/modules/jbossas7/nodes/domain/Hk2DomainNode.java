 ...
 * @author kulikov
 */
public class Hk2DomainNode extends AbstractNode implements ChangeListener {
    ...
    public Hk2DomainNode(final AS7Domain instance, boolean isFullNode) {
...
//        }
    ...
    private Hk2DomainNode(final AS7Domain instance, final InstanceContent ic, boolean isFullNode) {
        super(isFullNode ? new Hk2DomainChildren(instance) : Children.LEAF,
    ...
    public String getDisplayName() {
        return this.serverInstance.getDisplayName() + "[Domain]";
    }
