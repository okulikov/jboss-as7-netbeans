 ...
 * @author kulikov
 */
public class Hk2ServerGroupChildren extends Children.Keys<Node> implements Refreshable, ChangeListener {

    private AS7Domain serverInstance;

    public Hk2ServerGroupChildren(AS7Domain si) {
    ...
    public void updateKeys() {
        ...
        Collection<String> apps = serverInstance.getServerGroups();
